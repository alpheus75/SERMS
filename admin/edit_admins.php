...
<form action="update_incidents.php" method="POST">
  <div class="container">
  <?php
	$result = mysqli_query($mysqli,"SELECT * FROM admin_users WHERE Username ='$id'");
    ...
    echo"<input type='text' placeholder='Password' name='Password' value='{$row['Password']}' required>";
