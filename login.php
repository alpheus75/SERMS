        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-xs-12">
                    ...
                    ?>
                        <form id="contact" action="login_connect.php" method="post">
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <button type="submit" id="form-submit" class="main-button-icon">Login <i class="fa fa-arrow-right"></i></button>
                                Not yet Registered? <a href="register.php" class="main-button-icon">Sign Up</a>
                              </fieldset>
                            </div>
                        </form>
                    </div>
